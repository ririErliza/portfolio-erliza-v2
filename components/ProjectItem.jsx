...
const ProjectItem = ({title,desc,bgImg, projectUrl, codeUrl}) => {
  return (
    <>
        <div className='group relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 hover:bg-gradient-to-r from-[#6db8dd] to-[#709dff]'>
